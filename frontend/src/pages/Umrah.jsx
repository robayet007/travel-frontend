...
const Umrah = () => {
  ...
  const fetchPackages = async () => {
    try {
      setLoading(true)
      const response = await axios.get(`${API_BASE}/api/products/category/holy-umrah-hajj`)
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-xl text-gray-600">Loading Umrah packages...</div>
      </div>
    )
  }
    ...
    <section className="min-h-screen px-4 py-16 mx-auto bg-center bg-no-repeat bg-cover max-w-7xl">
      ...
      <div className="mb-12 text-center">
        ...
        <p className="mt-4 text-lg text-gray-600">
          Experience the spiritual journey of Umrah with our carefully crafted packages
        </p>
      </div>
